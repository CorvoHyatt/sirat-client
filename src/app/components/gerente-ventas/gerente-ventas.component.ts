...
@Component({
  selector: 'app-gerente-ventas',
  templateUrl: './gerente-ventas.component.html',
  styleUrls: ['./gerente-ventas.component.css']
})
export class GerenteVentasComponent implements OnInit 
{
  lista_agentes :  any;
